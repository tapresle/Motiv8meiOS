...
let INITIAL_PROMPT_VERSION = "INITIAL_PROMPT_1.3"
let CUSTOM_CREATION_PROMPT_VERSION = "CUSTOM_PROMPT_1.1"

let INITIAL_MESSAGE = "Welcome to Motiv8me! A new quote and picture will appear every 10 seconds. You can tap once to cycle through to another quote and picture or double tap to freeze on the current view, you can also long press to save the current image. Swipe up to create your own motivational image!"
